...
bowerJs = [
	...
	'development/bower_components/angular-touch/angular-touch.js',
...
gulp.task('gzipJs', ['scriptsMin', 'bowerMin'], function() {
...
// Build runs
gulp.task('default', ['scripts', 'scriptsMin', 'gzipJs', 'bowerScripts', 'bowerMin', 'styles', 'bowerStyles', 'gzipCss', 'views', 'fonts', 'images']);
